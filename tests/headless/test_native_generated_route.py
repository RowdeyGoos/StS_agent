...
def test_route_fixture_identity_and_first_combat_regression():
    rerun = json.loads((ROOT / 'docs/evidence/native_boosted_campaign_regressions_2026_09_20.json').read_text())
    assert {r['mode'] for r in rerun['runs']} == {'generated-start', 'generated-route'}
