...
from game.analysis.trace import analyze_episode_trace, format_finding
from game.analysis.watch import load_episode_trace
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "trace_path",
        type=str,
        help="Path to a JSON trace produced by sts-watch.",
    )
    parser.add_argument(
        "--max-findings",
        type=int,
