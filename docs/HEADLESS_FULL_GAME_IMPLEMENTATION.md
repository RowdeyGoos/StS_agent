...
3. **HF-28 / foreign-card acquisition:** the pinned solo census contains **80
   ...
   through `SILENT_CARDS`, and Regent through the cumulative `REGENT_CARDS`.
   **Necrobinder is the next family assignment**, followed by Defect: 160 ordinary
   cards remain across those two families. A partial catalog
