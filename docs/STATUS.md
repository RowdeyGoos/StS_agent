...
| Headless game engine | [Independent gameplay package](HEADLESS_ENGINE.md): playable restricted Ironclad A0 two-combat slice with rewards, rest/smith, Burning Blood, Fire/Block Potions and JSON continuation at every decision, including Armaments/True Grit combat hand choices, Weak, Uppercut and Shockwave. `sts-headless-play` exercises the loop; `--route overgrowth` adds four combats and two branch decisions with verified Fuzzy Wurm, Mawler, paired Nibbits and an optional Byrdonis elite. Elite rewards include 35–45 gold and Strawberry/Pear/Mango pickup effects; [first elite evidence](evidence/first_elite_2026_09_13.md). `--route overgrowth-act1` adds Vantom, Slippery/Wounds, Sword Boomerang, rare boss rewards and explicit Act 1 completion; [boss evidence](evidence/first_boss_2026_09_13.md). The Act 1 route now offers an optional merchant with supported card/relic/potion purchases, a card sale and cancelable permanent removal with escalating cost; [shop evidence](evidence/first_shop_2026_09_13.md). A treasure stop grants gold on opening, offers an optional fruit relic and supports depleted-pool Circlet fallback; [treasure evidence](evidence/first_treasure_2026_09_13.md), including an installed seed-2 left/rest authored Act 1 win. Jungle Maze Adventure adds native gold/damage choices and event continuation; [event evidence](evidence/first_event_2026_09_13.md). Aroma of Chaos adds mandatory permanent upgrade/transformation choices on the right branch, with a restricted Ironclad pool and exact selector restore; [Aroma evidence](evidence/aroma_of_chaos_2026_09_13.md). All 22 native Overgrowth encounter entries are now implemented at A0 (29 monster types, all three elites/bosses), including summons, revival and required powers; [roster evidence](evidence/overgrowth_roster_2026_09_13.md). A generated restricted Act 1 route now adds 15 map rows plus a boss, branching entrances and owned weak/normal/elite/boss queues; [map/progression evidence](evidence/generated_act1_2026_09_13.md). Its default map now applies native duplicate-path pruning/repair and resolves unknown rooms once using base odds and shop exclusions; [validation and limits](evidence/map_pruning_unknowns_2026_09_13.md). An optional restricted Neow start grants Golden Pearl or Nutritious Oyster before map entry, and generated event outcomes now follow an owned shuffled queue with native exhausted-pool repetition; [source and validation](evidence/neow_event_progression_2026_09_13.md). Tablet of Truth and Morphic Grove now extend that pool with repeated HP-for-upgrade decisions, two-card transformations and native Morphic entry eligibility. With the preceding four-event pool, the installed seed-2 right/rest Neow demo completed all 16 generated rooms and Vantom with 7 HP, with exact continuation throughout; [source and validation](evidence/overgrowth_events_2026_09_13.md). The preceding event pack added four definitions: Whispering Hollow, Wellspring, Slippery Bridge and Sunken Statue add potion bundles, removal, Guilty expiry and independent sword evolution; [source, validation and restricted pools](evidence/event_pack_2026_09_13.md). Dense Vegetation adds Rest → four-Wriggler combat → ordinary rewards → map, with separate owned event combat history; [source and validation](evidence/dense_vegetation_2026_09_13.md). Sapphire Seed expanded the generated pool to ten and adds permanent Sown enchantment state; the same native check corrected Guilty to discard normally rather than exhaust at turn end; [source and validation](evidence/sapphire_seed_2026_09_13.md). Byrdonis Nest now brings the pool to eleven, with Egg → rest-site Hatch → Byrdpip/Byrd Swoop and a restricted Finesse/Flash of Steel/Shockwave colorless transformation pool; [source and validation](evidence/byrdonis_nest_2026_09_13.md). Legacy experiment APIs consume the same combat rules. Native full-run fidelity remains open; [evidence and limits](evidence/first_vertical_slice_2026_09_13.md), [remaining tasks](HEADLESS_FULL_GAME_IMPLEMENTATION.md). The [solo Act 1 relic inventory](HEADLESS_ENGINE.md#relics) now has 161 registered rules with 160 default-catalog pickups; Kaleidoscope requires foreign character pools. All [51 potions in the solo Ironclad scope](HEADLESS_ENGINE.md#potions) now execute, and generated runs use the full 48-potion ordinary pool. All 21 normally Act-1-eligible events and randomized Neow offers are implemented (26 default-catalog solo offers; Kaleidoscope awaits foreign cards), with all 18 curses and resumable nested rewards; [source and validation](evidence/events_neow_2026_09_14.md). Generated runs now default to pinned MegaRandom primitives, native card/potion probabilities, shared relic bags and 13-slot merchant stock; combat call-order and complete interaction parity remain open. Runtime acquisition now applies native relic predicates/bag filtering, five merchant exclusions, marked card-reward pool rules and potion batch eligibility; [acquisition source and validation](evidence/runtime_eligibility_2026_09_14.md). [RNG source and validation](evidence/native_rng_2026_09_14.md). Native startup now matches actual assembly room queues and complete Act 1 maps across 13 reference seeds under declared solo/all-unlocked Overgrowth/Hive/Glory inputs; [initialization evidence](evidence/native_initialization_2026_09_14.md). |
