...
| Narrow profile metadata discovery | D1 and D1B passed with disclosed execution details | Separately approved hash-bound scopes | Nothing; see the [D1](../phase-0/research/PHASE_0_PROFILE_METADATA_DISCOVERY_RESULT.md) and [D1B](../phase-0/research/PHASE_0_PROFILE_BACKUP_SIDECAR_METADATA_RESULT.md) sanitized results |
...
[D1B probe](../phase-0/research/PHASE_0_PROFILE_BACKUP_SIDECAR_METADATA_RESULT.md)
...
exact frozen [PF-HASH request](../phase-0/PHASE_0_PROFILE_BASELINE_HASH_REQUEST.md). This
...
[stopped pre-content](../phase-0/research/PHASE_0_PROFILE_BASELINE_HASH_ATTEMPT_1_RESULT.md)
...
- [`PHASE_0_PROFILE_FIXTURE_PLAN.md`](../phase-0/PHASE_0_PROFILE_FIXTURE_PLAN.md) defines
  how live tests can be isolated from personal profile data.
- [`PHASE_0_PROFILE_METADATA_DISCOVERY_REQUEST.md`](../phase-0/PHASE_0_PROFILE_METADATA_DISCOVERY_REQUEST.md)
  preserves the exact hash-bound metadata-only scope that was approved.
- [`PHASE_0_PROFILE_METADATA_DISCOVERY_RESULT.md`](../phase-0/research/PHASE_0_PROFILE_METADATA_DISCOVERY_RESULT.md)
  records its sanitized pass, execution caveats, and remaining unknowns.
- [`PHASE_0_PROFILE_BACKUP_SIDECAR_METADATA_REQUEST.md`](../phase-0/PHASE_0_PROFILE_BACKUP_SIDECAR_METADATA_REQUEST.md)
  preserves the separate approved fixed-allowlist D1B scope.
- [`PHASE_0_PROFILE_BACKUP_SIDECAR_METADATA_RESULT.md`](../phase-0/research/PHASE_0_PROFILE_BACKUP_SIDECAR_METADATA_RESULT.md)
  records the sanitized current-projection pass and strict limits.
- [`PHASE_0_PROFILE_BACKUP_SIDECAR_RESULT_REVIEW.md`](../phase-0/research/PHASE_0_PROFILE_BACKUP_SIDECAR_RESULT_REVIEW.md)
  binds the independent D1B execution-result sign-offs to exact hashes.
- [`PHASE_0_PROFILE_RECOVERY_UNIT_METADATA_REQUEST.md`](../phase-0/PHASE_0_PROFILE_RECOVERY_UNIT_METADATA_REQUEST.md)
  preserves the reviewed D1C metadata-only alternative that was deliberately
  skipped and never executed.
- [`PHASE_0_PROFILE_RECOVERY_UNIT_SCOPE_REVIEW.md`](../phase-0/research/PHASE_0_PROFILE_RECOVERY_UNIT_SCOPE_REVIEW.md)
  binds the independent review of that preserved alternative to its exact hash.
- [`PHASE_0_PROFILE_BASELINE_HASH_REQUEST.md`](../phase-0/PHASE_0_PROFILE_BASELINE_HASH_REQUEST.md)
  ...
  approved.
- [`PHASE_0_PROFILE_BASELINE_HASH_SCOPE_REVIEW.md`](../phase-0/research/PHASE_0_PROFILE_BASELINE_HASH_SCOPE_REVIEW.md)
  binds the independent authorization, race/claim, canonicalization, and
  privacy reviews of PF-HASH to its exact hash.
- [`PHASE_0_PROFILE_BASELINE_HASH_ATTEMPT_1_RESULT.md`](../phase-0/research/PHASE_0_PROFILE_BASELINE_HASH_ATTEMPT_1_RESULT.md)
  records the sanitized pre-content stop, implementation deviation, and fresh
  approval boundary for a corrected invocation.
- [`PHASE_0_PROFILE_BASELINE_HASH_ATTEMPT_1_REVIEW.md`](../phase-0/research/PHASE_0_PROFILE_BASELINE_HASH_ATTEMPT_1_REVIEW.md)
  binds independent execution-stage, static-path, privacy, and authorization
  sign-offs to the exact stopped-result hash.
- [`PHASE_0_PROFILE_BASELINE_HASH_CORRECTED_RUNNER_SYNTHETIC_VALIDATION.md`](../phase-0/research/PHASE_0_PROFILE_BASELINE_HASH_CORRECTED_RUNNER_SYNTHETIC_VALIDATION.md)
...
- [`PHASE_0_PROFILE_METADATA_RESULT_REVIEW.md`](../phase-0/research/PHASE_0_PROFILE_METADATA_RESULT_REVIEW.md)
...
passed; see their [D1](../phase-0/research/PHASE_0_PROFILE_METADATA_DISCOVERY_RESULT.md)
and [D1B](../phase-0/research/PHASE_0_PROFILE_BACKUP_SIDECAR_METADATA_RESULT.md) sanitized
results.
