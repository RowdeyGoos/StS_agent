# Historical decision log through 2026-09-08

Copied from commit `4f0c9ed` with relative links adjusted. This preserves detailed
rationale and original D1–D64 identifiers. Dates, capabilities, worktree paths and
process instructions below describe earlier checkpoints, not current policy.
Use [current decisions](../../DECISIONS.md) and [AGENTS](../../AGENTS.md) instead
for current architecture and workflow. Read this archive only for a specific question.
...
[`docs/research/PHASE_1_HEADLESS_ENCODING_SCHEMA.json`](../research/PHASE_1_HEADLESS_ENCODING_SCHEMA.json),
