...
Use the [historical project README](https://github.com/RowdeyGoos/StS_agent/blob/9d8d1c75069f9bfb04e161c25706343c5b63ea42/README.md#reduced-headless-experiments) for CLI commands.

## Code and contracts

| Location | Responsibility |
| --- | --- |
| [Public encoder](https://github.com/RowdeyGoos/StS_agent/blob/9d8d1c75069f9bfb04e161c25706343c5b63ea42/game/agents/headless_encoding.py) | Public decision and legal-candidate representation |
...
| [Policy dataset](https://github.com/RowdeyGoos/StS_agent/blob/9d8d1c75069f9bfb04e161c25706343c5b63ea42/game/data/headless_policy_dataset.py) | Trusted examples with accepted artifact provenance |
| [Candidate policy](https://github.com/RowdeyGoos/StS_agent/blob/9d8d1c75069f9bfb04e161c25706343c5b63ea42/game/agents/headless_candidate_policy.py) | Masked variable-candidate scoring and persistence |
| [Behavior cloning](https://github.com/RowdeyGoos/StS_agent/blob/9d8d1c75069f9bfb04e161c25706343c5b63ea42/game/training/headless_behavior_clone.py) | Deterministic CPU training smoke and artifact publication/load |
...
The [actor-ready ledger](../phase-1/research/PHASE_1_ACTOR_READY_ACCEPTANCE.md)
