...
| Embedded event combat | Non-resuming entry and callback-verified event resumption are implemented offline, with exact ownership and bounded host composition; Dense Vegetation Fight after Rest and Battleworn Dummy Setting2/training expiry are pending live cases | Unreleased and not live-demonstrated; interactive resume children, extra rewards and recursive combat cycles remain unsupported; automatic effects unverified |
