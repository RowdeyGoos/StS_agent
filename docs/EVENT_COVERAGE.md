...
| Event card rewards and multiple reward entries | `item_set_v1` supports 2–8 potion/relic entries offline; Cheese uses a different add-grid surface | CardReward/SpecialCardReward, mixed card/item sets and nested pickup/selector ownership remain gaps |
