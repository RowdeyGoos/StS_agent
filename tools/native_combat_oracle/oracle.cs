...
if (args.Length is not (2 or 3) || (args.Length == 3 && args[2] is not ("generation" or "interactions" or "transforms" or "silent" or "regent" or "necrobinder" or "defect" or "foreign"))) throw new ArgumentException("Usage: oracle <pinned-sts2.dll> <dependency-directory> [generation|interactions|transforms|silent|regent|necrobinder|defect|foreign]");
