...
internal static class RegentOracle
{
    public static void Run(Assembly asm, string digest)
    {
        ...
        var pool=Get("CardPool","CardPools.RegentCardPool");
        var originals=Items(Call(pool,"GetUnlockedCards",unlock,single)).Concat(new[]{Get("Card","Cards.SovereignBlade"),Get("Card","Cards.MinionStrike"),Get("Card","Cards.MinionDiveBomb"),Get("Card","Cards.MinionSacrifice")}).ToArray();
