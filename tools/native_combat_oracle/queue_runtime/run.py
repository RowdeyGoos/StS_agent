...
def main():
    ...
    for name in ("queue_oracle.csproj", "Oracle.cs", "paused_hooks.cs", "death_draw.cs", "enemy_turn.cs", "autoplay.cs", "draw_cards.cs", "remaining_draw.cs", "interactions.cs", "item_status.cs", "enemy_interactions.cs", "side_start.cs", "end_boundary.cs", "reward_handoff.cs", "event_inventory.cs", "event_roster.cs", "event_minigame.cs", "campaign.cs", "generated_start.cs", "kaiser_presentation.cs", "kaiser_skeleton.spjson", "kaiser_empty.atlas", "empty.tscn"):
