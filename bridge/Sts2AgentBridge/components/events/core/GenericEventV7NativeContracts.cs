...
public abstract record GenericEventV7Admission(object Identity) {
    public bool IsSupported => Identity is not null && (this switch {
        ...
        GenericEventV7RewardAdmission r => r.OfferCount is >=1 and <=8,
...
public sealed record GenericEventV7RewardAdmission(object AdmissionIdentity,int OfferCount=1) : GenericEventV7Admission(AdmissionIdentity);
