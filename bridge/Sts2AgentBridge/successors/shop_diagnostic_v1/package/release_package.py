...
DLL_NAME = "Sts2AgentBridgeShopDiagnosticV1.dll"
MANIFEST_NAME = "Sts2AgentBridgeShopDiagnosticV1.json"
ZIP_NAME = "Sts2AgentBridgeShopDiagnosticV1-1.0.0.zip"
ARTIFACT_ROOT = Path("/private/tmp/sts-shop-diagnostic-v1-release")
IDENTITIES = {
    DLL_NAME: (83968, "c4151b5277715e605417e064bd249d7d8ad9bc0a9d2d0be6408a56be2b65771b"),
    MANIFEST_NAME: (353, "3c6d1ae87fd339868c3cc52a5fa8115968402aa8a6c981fa8d64a5c7a909946d"),
    ZIP_NAME: (84765, "e249e180f88937ade8d64428b5708f6080749f754e100408ea902afb6a2454e0"),
}
MANIFEST = b'''{
  "id": "Sts2AgentBridgeShopDiagnosticV1",
  "name": "STS2 Agent Bridge Shop Diagnostic V1",
  "author": "StS Agent Project",
  "description": "Restricted read-only shop diagnostic for StS agent research",
  "version": "1.0.0",
  "has_pck": false,
  "has_dll": true,
  "dependencies": [],
...
def canonical_files(dll: bytes) -> dict[str, bytes]:
    ...
    with zipfile.ZipFile(output, "w", compression=zipfile.ZIP_STORED, allowZip64=False) as archive:
        for name, data in ((DLL_NAME, dll), (MANIFEST_NAME, MANIFEST)):
            info = zipfile.ZipInfo("Sts2AgentBridgeShopDiagnosticV1/" + name, (1980, 1, 1, 0, 0, 0))
