"""Verify exact diagnostic specialization of accepted operational sources."""
...
if __name__ == "__main__":
    print(json.dumps({"schema_version":1,"status":"passed","suite":"shop_diagnostic_operations_derivation","check_count":verify()},separators=(",",":")))
