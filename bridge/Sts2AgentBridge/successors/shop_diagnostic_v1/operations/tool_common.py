...
CANONICAL_MANIFEST = (
    b'{\n'
    b'  "id": "Sts2AgentBridgeShopDiagnosticV1",\n'
    b'  "name": "STS2 Agent Bridge Shop Diagnostic V1",\n'
    b'  "author": "StS Agent Project",\n'
    b'  "description": "Restricted read-only shop diagnostic for StS agent research",\n'
    b'  "version": "1.0.0",\n'
    b'  "has_pck": false,\n'
    b'  "has_dll": true,\n'
    b'  "dependencies": [],\n'
