...
internal static class ShopDiagnosticBootstrapHost
{
    ...
    internal static void Initialize()
    {
        ...
        try
        {
            lifecycle = new RoomFlowBootstrapLifecycle(
                ...
                new RoomFlowGodotFrameConnector(),
                new ProductionShopDiagnosticRuntimeFactory(),
    ...
    {
        ItemOperatorConfiguration? configuration = ShopDiagnosticOperatorFiles.OpenEnabled();
