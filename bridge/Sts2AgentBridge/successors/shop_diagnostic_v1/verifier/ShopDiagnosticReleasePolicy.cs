...
internal sealed class ShopDiagnosticReleasePolicy
{
    ...
    internal const string ExpectedPolicySha256 = "38e169931014710a47d0a60b0b4346b644111189dfd42210a0a16fc854ae9c34";
    internal const long ExpectedCandidateLength = 83968;
    internal const int ExpectedSourceCount = 24;
    ...
    internal static ShopDiagnosticReleasePolicy Parse(byte[] bytes)
    {
        ShopDiagnosticReleasePolicy? policy;
        try
        {
            policy = JsonSerializer.Deserialize<ShopDiagnosticReleasePolicy>(bytes, new JsonSerializerOptions
            {
