"""Canonical, byte-pinned Generic Event V9 package. No install or game operations."""
...
DLL_NAME = "Sts2AgentBridgeGenericEventV9.dll"
MANIFEST_NAME = "Sts2AgentBridgeGenericEventV9.json"
ZIP_NAME = "Sts2AgentBridgeGenericEventV9-1.0.0.zip"
ARTIFACT_ROOT = Path("/private/tmp/sts-generic-event-v9-release")
IDENTITIES = {
    DLL_NAME: (390144, "e8c7856b29d2acee24e867b1f7c748e4bd9e83e189449c3b5b38e7b31aac75a3"),
    MANIFEST_NAME: (352, "c2df30bf27f9c381305f73893b77f5813a8b8c48fb257161b479cfda4bd31112"),
    ZIP_NAME: (390924, "8f896d71770ec079ebc369980b1416e338fbfb1fce60143e813c9ce057604d8a"),
}
MANIFEST = b'''{
  "id": "Sts2AgentBridgeGenericEventV9",
  "name": "STS2 Agent Bridge Generic Event V9",
...
def canonical_files(dll: bytes) -> dict[str, bytes]:
    ...
    with zipfile.ZipFile(output, "w", compression=zipfile.ZIP_STORED, allowZip64=False) as archive:
        for name, data in ((DLL_NAME, dll), (MANIFEST_NAME, MANIFEST)):
            info = zipfile.ZipInfo("Sts2AgentBridgeGenericEventV9/" + name, (1980, 1, 1, 0, 0, 0))
