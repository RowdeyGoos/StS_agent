...
CONTRACT = "c74fb8dc3229c8f9b9e3153909b6416b85202bda6fd1d098bc716672d8c8a2ea"
PREVIOUS_CHECK_SHA256 = "222e6f7222850801511e10417a1da8fd50d66c32fda00252357483db7ce02598"
...
def verify_sources() -> None:
    path = ROOT.parent/'generic_event_release_v8/check.py'
    ...
    if (manifest.get('schema_version') != 1 or manifest.get('component') != 'generic_event_release_v9'
