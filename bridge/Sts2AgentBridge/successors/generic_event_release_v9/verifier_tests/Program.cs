...
using Sts2AgentBridge.Successors.GenericEventReleaseV9;
...
internal static class Program
{
    ...
    private static readonly string[] ProductionSources = {
        ...
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/gameplay/GenericEventV7TransformAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/lifecycle/GenericEventBootstrapLifecycle.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/native/GenericEventBootstrapHost.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/native/GenericEventBootstrapSupport.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/native/GenericEventGodotFrameConnector.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/native/GenericEventModEntry.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/native/PinnedGenericEventHarmonyGuard.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/native/ProductionGenericEventRuntimeFactory.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/operator/GenericEventOperatorFiles.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/runtime/GenericEventDiagnosticCode.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/runtime/GenericEventDiagnosticCodec.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/runtime/GenericEventTransportConfiguration.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/runtime/GenericEventTransportContracts.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/runtime/GenericEventTransportProtocol.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/runtime/GenericEventTransportRuntime.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v9/runtime/OwnedByteFrameQueue.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v5/core/GenericEventV5ChildSession.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/core/GenericEventV7ChildSession.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/core/GenericEventV7Contracts.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/core/GenericEventV7ItemChildSession.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/core/GenericEventV7NativeContracts.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/core/GenericEventV7Session.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/GenericEventV7Binding.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/GenericEventV7CardAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/GenericEventV7Hooks.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/GenericEventV7ItemAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/GenericEventV7ItemState.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/GenericEventV7MultiUpgradeAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/GenericEventV7MultiUpgradeState.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/GenericEventV7RemovalAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/GenericEventV7RewardAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/GenericEventV7TransformState.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/native/PinnedGenericEventV7NativeAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/transform_core/CardTransformV2Journal.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/transform_core/CardTransformV2NativeContracts.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/transform_core/CardTransformV2Session.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/wire/CardTransformV2WireCodec.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/wire/GenericEventV7WireCodec.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v7/wire/GenericEventV7WireService.cs",
    ...
    private const string ExpectedSourceProjectionSha256 = "10684a9161d0283c87c7ead6f3701d0b61ba722126bb35cd4494c129612c36d7";
    ...
    public static int Main(string[] args)
    {
        try
        {
            ...
            Console.WriteLine(JsonSerializer.Serialize(new SortedDictionary<string, object>(StringComparer.Ordinal)
            {
                ...
                ["schema_version"] = 1,
                ["status"] = "passed",
                ["suite"] = "generic_event_v9_release_verifier",
            }));
            return 0;
        }
        catch
        {
            Console.WriteLine("{\"schema_version\":1,\"status\":\"failed\",\"suite\":\"generic_event_v9_release_verifier\"}");
            return 1;
        }
    }
    ...
    private static void Run(string candidatePath, string sourceRoot, string policyPath)
    {
        ...
        {
            string owner=target=="member:Godot.Control.GetGlobalRect()" ? GenericEventOffscreenSurface.Probe+".TryRect(Godot.Control,Godot.Rect2&)" :
                target is "member:Godot.CanvasItem.GetGlobalTransform()" or "member:Godot.CanvasItem.IsSetAsTopLevel()" ?
                GenericEventOffscreenSurface.Node+".TryBind(Godot.Node,Godot.Rid,NodeGeometry&)" :
                GenericEventOffscreenSurface.Probe+".TryBind(Grid,Candidate[],ProbeGeometry&)";
            ...
            Check(GenericEventReleaseProjectionBuilder.IsForbiddenRuntimeReference(owner.Replace(".Try", ".TryExtra",StringComparison.Ordinal),target));
            string[] changed=projection.Inventory.Where(row=>!row.StartsWith("offscreen_api|",StringComparison.Ordinal)||!row.EndsWith("|"+target,StringComparison.Ordinal)).ToArray();
        ...
        const string guardOwner = "Sts2AgentBridge.Successors.GenericEventReleaseV9.PinnedGenericEventHarmonyGuard.Verify()";
        ...
        foreach (string diagnosticType in new[] { "GenericEventDiagnosticCode", "GenericEventDiagnosticCodec" })
        {
            ...
            string replacement = changed[index].Replace("GenericEventReleaseV5.", "GenericEventReleaseV9.", StringComparison.Ordinal);
        ...
        Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(projection with
        {
            ...
            {
                "method_def|06ffffff|Sts2AgentBridge.Successors.GenericEventReleaseV9.GenericEventModEntry.Initialize(System.String)|System.Void|0|1|0|150|0",
            }).OrderBy(value => value, StringComparer.Ordinal).ToArray(),
        }), "initializer_or_friend_surface");
    ...
    private static (int Exit, string Output) InvokeProduction(string candidate, string sourceRoot, string policy)
    {
        ...
        try
        {
            ...
            int exit = Sts2AgentBridge.Successors.GenericEventReleaseV9.Program.Main(new[]
            {
