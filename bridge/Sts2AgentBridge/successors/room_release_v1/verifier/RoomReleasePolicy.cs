...
internal sealed class RoomReleasePolicy
{
    ...
    internal const string ExpectedPolicySha256 = "6cde6aac22dd7a8e73416da9b75209ba44bb18d8c9be1e5d92e1d6b4d32af81f";
    ...
    internal static RoomReleasePolicy Parse(byte[] bytes)
    {
        RoomReleasePolicy? policy;
        try
        {
            policy = JsonSerializer.Deserialize<RoomReleasePolicy>(bytes, new JsonSerializerOptions
            {
