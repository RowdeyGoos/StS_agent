...
internal static class Program
{
    private static readonly byte[] Generic = Encoding.ASCII.GetBytes(
        "{\"schema_version\":\"generic_event_v7_transport_config_v1\",\"enabled\":true,\"flow_kind\":\"generic\",\"bind_address\":\"127.0.0.1\",\"port\":43117,\"token_file\":\"credential.hex\"}");
    ...
    internal static int Main(string[] arguments)
    {
        ...
        try
        {
            ...
            Console.WriteLine("{\"schema_version\":1,\"status\":\"passed\",\"suite\":\"generic_event_v7_operator\",\"check_count\":" + _checks + "}");
            return 0;
        }
        catch
        {
            Console.Error.WriteLine("generic_event_v7_operator_tests_failed");
            return 1;
        }
        finally
        {
    ...
    private static void DefaultDenyAndIsolation()
    {
        byte[][] rejected =
        {
            Encoding.ASCII.GetBytes("{\"schema_version\":\"generic_event_v6_transport_config_v1\",\"enabled\":true,\"flow_kind\":\"generic\",\"bind_address\":\"127.0.0.1\",\"port\":43117,\"token_file\":\"credential.hex\"}"),
            ...
            Encoding.ASCII.GetBytes("{\"schema_version\":\"generic_event_v7_transport_config_v1\",\"enabled\":false,\"flow_kind\":\"generic\",\"bind_address\":\"127.0.0.1\",\"port\":43117,\"token_file\":\"credential.hex\"}"),
            Encoding.ASCII.GetBytes("{\"schema_version\":\"generic_event_v7_transport_config_v1\",\"enabled\":true,\"flow_kind\":\"rest\",\"bind_address\":\"127.0.0.1\",\"port\":43117,\"token_file\":\"credential.hex\"}"),
    ...
    private static string RoomPath => Path.Combine(BridgePath, "generic_event_v7");
