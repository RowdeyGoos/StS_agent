"""Canonical, byte-pinned Generic Event V7 package. No install or game operations."""
...
DLL_NAME = "Sts2AgentBridgeGenericEventV7.dll"
MANIFEST_NAME = "Sts2AgentBridgeGenericEventV7.json"
ZIP_NAME = "Sts2AgentBridgeGenericEventV7-1.0.0.zip"
ARTIFACT_ROOT = Path("/private/tmp/sts-generic-event-v7-release")
IDENTITIES = {
    DLL_NAME: (382464, "b71634e61a6d47a562241c943f64e8c5659ebe9ec417e5c3d3b8ff835aac7f22"),
    MANIFEST_NAME: (352, "e814b2354922698f6346ec9c9d4009445459714a2cbd3ea7864326fa9d8c4bd6"),
    ZIP_NAME: (383244, "2423e1d3b3ba5179a5247eadb417db455ac030087885ad1d2d4d1d98916089b0"),
}
MANIFEST = b'''{
  "id": "Sts2AgentBridgeGenericEventV7",
  "name": "STS2 Agent Bridge Generic Event V7",
...
def canonical_files(dll: bytes) -> dict[str, bytes]:
    ...
    with zipfile.ZipFile(output, "w", compression=zipfile.ZIP_STORED, allowZip64=False) as archive:
        for name, data in ((DLL_NAME, dll), (MANIFEST_NAME, MANIFEST)):
            info = zipfile.ZipInfo("Sts2AgentBridgeGenericEventV7/" + name, (1980, 1, 1, 0, 0, 0))
