...
sys.path[:0] = [str(ROOT / 'client'), str(ROOT / 'operations'), str(ROOT / 'transport'), str(ROOT / 'transport_tests'), str(ROOT.parent)]
...
if __name__=='__main__':
    ...
    if result.wasSuccessful(): print(json.dumps({'schema_version':1,'status':'passed','suite':'card_selection_release_client','check_count':result.testsRun},separators=(',',':')))
