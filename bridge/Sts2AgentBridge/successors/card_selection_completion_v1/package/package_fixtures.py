...
class PackageTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.files = package.canonical_files(package.read_regular(Path(sys.argv[1]), package.IDENTITIES[package.DLL_NAME][0]))
...
if __name__ == '__main__':
    ...
    if result.wasSuccessful(): print('{"schema_version":1,"status":"passed","suite":"card_selection_completion_package","check_count":5,"mutation_cases":9}')
