...
CONTRACT = "d23e886df85e88ac3fce3f19fb35199580c54825edb066afba52ff0355f074ed"
PREVIOUS_CHECK_SHA256 = "633e4bc3a826f78d2f8ecd97e5305359e24bce08abba7fb7714f49cff44dadd0"
...
def verify_sources() -> None:
    path = ROOT.parent/'generic_event_v6/check.py'
    ...
    if (manifest.get('schema_version') != 1 or manifest.get('component') != 'generic_event_release_v6'
