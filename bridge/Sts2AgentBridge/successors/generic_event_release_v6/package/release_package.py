"""Canonical, byte-pinned Generic Event V6 package. No install or game operations."""
...
DLL_NAME = "Sts2AgentBridgeGenericEventV6.dll"
MANIFEST_NAME = "Sts2AgentBridgeGenericEventV6.json"
ZIP_NAME = "Sts2AgentBridgeGenericEventV6-1.0.0.zip"
ARTIFACT_ROOT = Path("/private/tmp/sts-generic-event-v6-release")
IDENTITIES = {
    DLL_NAME: (379392, "96723ba26f9f64a74cd0f1d8ae4217191a13410c5629a1feedc26a44f3890c2f"),
    MANIFEST_NAME: (352, "c7480a29c041269b9b0991826fa2fd4408cc8673a4427dac9ca299c9396ece62"),
    ZIP_NAME: (380172, "ecc08551b583fdc64e3fab87bbf6bf3a0ba09ef9e8d5521a824261ee6c97ddd3"),
}
MANIFEST = b'''{
  "id": "Sts2AgentBridgeGenericEventV6",
  "name": "STS2 Agent Bridge Generic Event V6",
...
def canonical_files(dll: bytes) -> dict[str, bytes]:
    ...
    with zipfile.ZipFile(output, "w", compression=zipfile.ZIP_STORED, allowZip64=False) as archive:
        for name, data in ((DLL_NAME, dll), (MANIFEST_NAME, MANIFEST)):
            info = zipfile.ZipInfo("Sts2AgentBridgeGenericEventV6/" + name, (1980, 1, 1, 0, 0, 0))
