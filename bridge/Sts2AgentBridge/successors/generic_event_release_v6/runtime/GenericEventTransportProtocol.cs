...
{
    private static ReadOnlySpan<byte> GetLine => "GET /probe/generic-event-v6/public/decision HTTP/1.1"u8;
    private static ReadOnlySpan<byte> PostLine => "POST /probe/generic-event-v6/public/action HTTP/1.1"u8;
