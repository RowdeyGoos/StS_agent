...
internal static class Program
{
    ...
    private static readonly string[] ProductionSources = {
        ...
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/lifecycle/GenericEventBootstrapLifecycle.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/native/GenericEventBootstrapHost.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/native/GenericEventBootstrapSupport.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/native/GenericEventGodotFrameConnector.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/native/GenericEventModEntry.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/native/PinnedGenericEventHarmonyGuard.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/native/ProductionGenericEventRuntimeFactory.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/operator/GenericEventOperatorFiles.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/runtime/GenericEventTransportConfiguration.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/runtime/GenericEventTransportContracts.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/runtime/GenericEventTransportProtocol.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/runtime/GenericEventTransportRuntime.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_release_v6/runtime/OwnedByteFrameQueue.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v5/core/GenericEventV5ChildSession.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v5/transform_core/CardTransformV1Journal.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v5/transform_core/CardTransformV1NativeContracts.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v5/transform_core/CardTransformV1Session.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v5/wire/CardTransformV1WireCodec.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/core/GenericEventV6ChildSession.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/core/GenericEventV6Contracts.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/core/GenericEventV6ItemChildSession.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/core/GenericEventV6NativeContracts.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/core/GenericEventV6Session.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6Binding.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6CardAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6Hooks.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6ItemAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6ItemState.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6MultiUpgradeAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6MultiUpgradeState.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6RemovalAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6RewardAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6TransformAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/GenericEventV6TransformState.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/native/PinnedGenericEventV6NativeAdapter.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/wire/GenericEventV6WireCodec.cs",
        "bridge/Sts2AgentBridge/successors/generic_event_v6/wire/GenericEventV6WireService.cs",
    ...
    private const string ExpectedSourceProjectionSha256 = "ead097f742daf97e185dd897f50926e5f98f14a7211c1ec278df4e15e986e830";
    ...
    public static int Main(string[] args)
    {
        try
        {
            ...
            Console.WriteLine(JsonSerializer.Serialize(new SortedDictionary<string, object>(StringComparer.Ordinal)
            {
                ...
                ["schema_version"] = 1,
                ["status"] = "passed",
                ["suite"] = "generic_event_v6_release_verifier",
            }));
            return 0;
        }
        catch
        {
            Console.WriteLine("{\"schema_version\":1,\"status\":\"failed\",\"suite\":\"generic_event_v6_release_verifier\"}");
            return 1;
        }
    }
    ...
    private static void Run(string candidatePath, string sourceRoot, string policyPath)
    {
        ...
        foreach (string prefix in new[] { "hitbox_helper|", "hitbox_call|", "hitbox_call|Sts2AgentBridge.Successors.GenericEventV6.Native.GenericEventV6RewardAdapter.TryCaptureBindings(" })
        {
        ...
        const string hookOwner = "Sts2AgentBridge.Successors.GenericEventV6.Native.GenericEventV6Hooks.Hook(System.String)";
        const string guardOwner = "Sts2AgentBridge.Successors.GenericEventReleaseV6.PinnedGenericEventHarmonyGuard.Verify()";
        ...
        Check(GenericEventReleaseProjectionBuilder.IsForbiddenRuntimeReference(hookOwner.Replace("GenericEventV6Hooks.", "GenericEventV6HooksExtra.", StringComparison.Ordinal), getMethod));
        const string boundHookOwner = "Sts2AgentBridge.Successors.GenericEventV6.Native.GenericEventV6Hooks..ctor(System.Action<System.Int32>,System.Action)";
        ...
        foreach (string diagnosticType in new[] { "GenericEventDiagnosticCode", "GenericEventDiagnosticCodec" })
        {
            ...
            string replacement = changed[index].Replace("GenericEventReleaseV5.", "GenericEventReleaseV6.", StringComparison.Ordinal);
        ...
        Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(projection with
        {
            ...
            {
                "method_def|06ffffff|Sts2AgentBridge.Successors.GenericEventReleaseV6.GenericEventModEntry.Initialize(System.String)|System.Void|0|1|0|150|0",
            }).OrderBy(value => value, StringComparer.Ordinal).ToArray(),
        }), "initializer_or_friend_surface");
        ...
        {
            ("GET /probe/generic-event-v6/public/decision HTTP/1.1", "GET /probe/generic-event-v6/public/decisio0 HTTP/1.1"),
            ("POST /probe/generic-event-v6/public/action HTTP/1.1", "POST /probe/generic-event-v6/public/actio0 HTTP/1.1"),
        })
        {
        ...
        byte[] wrapperBypass = PeMutations.ChangeCriticalTypeName(
            candidate, "PinnedGenericEventV6NativeAdapter");
        Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(
        ...
        byte[] frameBypass = PeMutations.ChangeCriticalTypeName(
            candidate, "GenericEventV6WireService");
        Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(
    ...
    private static (int Exit, string Output) InvokeProduction(string candidate, string sourceRoot, string policy)
    {
        ...
        try
        {
            ...
            int exit = Sts2AgentBridge.Successors.GenericEventReleaseV6.Program.Main(new[]
            {
