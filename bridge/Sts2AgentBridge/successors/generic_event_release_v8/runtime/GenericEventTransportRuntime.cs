...
public sealed class GenericEventTransportRuntime : IDisposable
{
    ...
    private GenericEventV7WireService? _service;
    ...
    public static GenericEventTransportRuntime? Create(
        ...
        Func<GenericEventReleaseSelection, string, GenericEventV7WireService> factory,
        Func<GenericEventDiagnosticCode>? diagnosticProvider = null)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                authenticator = null;
                GenericEventV7WireService service;
                try
                {
    ...
    private async Task HandleSocketAsync(Socket socket, CancellationToken stopToken)
    {
        ...
        try
        {
            ...
            string route = parsed.IsPost ? GenericEventV7WireService.ActionRoute : GenericEventV7WireService.DecisionRoute;
...
#endif
                GenericEventV7WireService service = _service ??
