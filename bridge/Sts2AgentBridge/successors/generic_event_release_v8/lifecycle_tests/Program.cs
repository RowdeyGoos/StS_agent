...
internal static class Program
{
    ...
    internal static int Main(string[] arguments)
    {
        ...
        try
        {
            ...
            Console.WriteLine("{\"schema_version\":1,\"status\":\"passed\",\"suite\":\"generic_event_v8_bootstrap\",\"check_count\":" + _checks + "}");
            return 0;
        }
        catch
        {
            Console.Error.WriteLine("generic_event_v8_bootstrap_tests_failed");
            return 1;
        }
    }
