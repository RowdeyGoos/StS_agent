...
{
    private const string ExpectedAssemblyName = "Sts2AgentBridgeGenericEventV8";
    ...
    private const string ExpectedInitializer =
        "type:Sts2AgentBridge.Successors.GenericEventReleaseV8.GenericEventModEntry|" +
    ...
    private const string ExpectedEntryType =
        "type_def|Sts2AgentBridge.Successors.GenericEventReleaseV8.GenericEventModEntry|1048961|System.Object|0|0";
    private const string ExpectedEntryMethodSuffix =
        "|Sts2AgentBridge.Successors.GenericEventReleaseV8.GenericEventModEntry.Initialize()|System.Void|0|0|0|150|0";
    ...
    internal static void VerifySemanticRules(GenericEventReleaseProjection projection)
    {
        ...
        if (!projection.InitializerAttributes.SequenceEqual(new[] { ExpectedInitializer }, StringComparer.Ordinal) ||
            ...
            projection.Inventory.Count(value => value.StartsWith(
                ...
                "|Sts2AgentBridge.Successors.GenericEventReleaseV8.GenericEventModEntry.",
    ...
    private static void VerifyCriticalFlow(string[] references, string[] inventory)
    {
        ...
        const string guardedFactory = "Sts2AgentBridge.Successors.GenericEventReleaseV8.ProductionGenericEventRuntimeFactory.CreateService(Sts2AgentBridge.Successors.GenericEventReleaseV8.GenericEventReleaseSelection,System.String,Sts2AgentBridge.Successors.GenericEventReleaseV8.ProductionGenericEventRuntimeFactory+Runtime)";
        ...
        if (guards.Length != 1 || entries.Length != 1 || Owner(guards[0]) != guardedFactory ||
            ...
            throw new VerificationException("critical_flow_forbidden");
        string factory = "critical|Sts2AgentBridge.Successors.GenericEventReleaseV8.ProductionGenericEventRuntimeFactory.CreateVerifiedService(";
        string runtime = "critical|Sts2AgentBridge.Successors.GenericEventReleaseV8.GenericEventTransportRuntime+";
