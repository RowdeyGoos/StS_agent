"""Canonical, byte-pinned Generic Event V8 package. No install or game operations."""
...
DLL_NAME = "Sts2AgentBridgeGenericEventV8.dll"
MANIFEST_NAME = "Sts2AgentBridgeGenericEventV8.json"
ZIP_NAME = "Sts2AgentBridgeGenericEventV8-1.0.0.zip"
ARTIFACT_ROOT = Path("/private/tmp/sts-generic-event-v8-release")
IDENTITIES = {
    DLL_NAME: (386048, "3bea54724f61a9d6afe3b89783a6393b1cb5e24adcc68d7129196a7bd3309a68"),
    MANIFEST_NAME: (352, "55636a2930ca9888229ecc7c7c4c8d57c11825a05c29bb4e28023a6c0f725568"),
    ZIP_NAME: (386828, "5d50e7731ad7b8ace9259712fd2abb604ad6aa6657d9ccc01995d808112d1fd4"),
}
MANIFEST = b'''{
  "id": "Sts2AgentBridgeGenericEventV8",
  "name": "STS2 Agent Bridge Generic Event V8",
...
def canonical_files(dll: bytes) -> dict[str, bytes]:
    ...
    with zipfile.ZipFile(output, "w", compression=zipfile.ZIP_STORED, allowZip64=False) as archive:
        for name, data in ((DLL_NAME, dll), (MANIFEST_NAME, MANIFEST)):
            info = zipfile.ZipInfo("Sts2AgentBridgeGenericEventV8/" + name, (1980, 1, 1, 0, 0, 0))
