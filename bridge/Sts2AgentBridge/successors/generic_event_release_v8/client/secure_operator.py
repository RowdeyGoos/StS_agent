...
CONFIGURATIONS = {"generic": b'{"schema_version":"generic_event_v8_transport_config_v1","enabled":true,"flow_kind":"generic","bind_address":"127.0.0.1","port":43117,"token_file":"credential.hex"}'}
...
def read_credential(home: Path, uid: int, state: Any,
    ...
    try:
        ...
        item = open_entry('generic_event_v8', private=True, owned=True)
