...
CONTRACT = "ae6af92e4de9d6c676ce65455baca2572a03137fa5a0b8b27c7d2803f059f7d3"
PREVIOUS_CHECK_SHA256 = "db501e62582fb3f512166729f5a588e7f69b3b6021bff6430a7c1dbf9742170f"
...
def verify_sources() -> None:
    path = ROOT.parent/'generic_event_release_v7/check.py'
    ...
    if (manifest.get('schema_version') != 1 or manifest.get('component') != 'generic_event_release_v8'
