...
internal static partial class Program
{
    ...
    {
        InvalidRequests(); ReceiptsAndFailures(); Lifecycle(); PendingLimits(); GenericValidation();
        Console.WriteLine(JsonSerializer.Serialize(new {schema_version=1,status="passed",suite="event_card_operations_v1_wire",check_count=_checks}));
    }
    ...
    private sealed class Adapter : IEventOrchestratorV1NativeAdapter
    {
        ...
        internal Adapter(string key)
        {
            ...
            _candidate=new(0,key,"Choose",true,true,false,false,false,new object(),new object(),new object(),()=>Dispatches++,EventOrchestratorV1CapabilityKind.OrdinaryItemEligible,0,policy,factory);
        }
