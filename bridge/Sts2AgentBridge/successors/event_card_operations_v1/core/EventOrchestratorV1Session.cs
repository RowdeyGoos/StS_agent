...
public sealed class EventOrchestratorV1Session : IEventOrchestratorV1Session
{
    ...
    private IRoomFlowReadValue ReadSurface()
    {
        ...
        if (projected.Observation.Status == EventOrchestratorV1Limits.UnsupportedStatus)
        {
            LatchUnsupported();
            return Unsupported();
        }
    ...
    private IRoomFlowReadValue ReadPending(EventOrchestratorV1SurfaceCapture capture)
    {
        ...
        if (_accepted is EventOrchestratorV1AcceptedContext accepted &&
        ...
        out PublishedDecision? decision)
    {
        ...
        for (int index = 0; index < capture.Candidates.Count; index++)
        {
            ...
            string policy = PolicyName(native);
    ...
    {
        if (!Enum.IsDefined(candidate.CapabilityKind)) return false;
    ...
    private static bool ValidPolicy(EventOrchestratorV1ChildPolicy policy)
    {
        ...
        try
        {
            EventOrchestratorV1ChildPolicy rebound =
    ...
    private static string PolicyName(EventOrchestratorV1NativeCandidate candidate) =>
