...
namespace MegaCrit.Sts2.Core.Models.Events
{
    ...
    public class AromaOfChaos : MegaCrit.Sts2.Core.Models.EventModel { }
    public class SapphireSeed : MegaCrit.Sts2.Core.Models.EventModel { }
...
namespace MegaCrit.Sts2.Core.Nodes.Screens.CardSelection
{
    ...
    public class NDeckUpgradeSelectScreen : Godot.Control { }
}
