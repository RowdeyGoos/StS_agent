    ...
    : IEventOrchestratorV1NativeChildFactoryBuilder
{
    ...
    public IEventOrchestratorV1ChildFactory CreateEventCard(EventOrchestratorV1ChildPolicy p,
        PinnedEventOrchestratorV1NativeAdapter.BoundEvent b, EventCardOperationBinding binding,
        EventOption o, NEventOptionButton c) => _inner.CreateEventCard(p, b, binding, o, c);
}
