# Generic event v1 wire

GET `/probe/generic-event-v1/public/decision` has no body. POST
`/probe/generic-event-v1/public/action` is a canonical UTF-8 JSON object with
...
(`generic_event_v1`), `session_nonce` (32 lowercase hex), `kind`, `parent`,
...
native family requires upgrade,1,1,preview_confirm,2..64. Its payload is the
