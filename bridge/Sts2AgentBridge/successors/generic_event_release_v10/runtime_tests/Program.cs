...
internal static class Program
{
    ...
    private static readonly byte[] Config=Encoding.UTF8.GetBytes("{\"schema_version\":\"generic_event_v10_transport_config_v1\",\"enabled\":true,\"flow_kind\":\"generic\",\"bind_address\":\"127.0.0.1\",\"port\":43117,\"token_file\":\"credential.hex\"}");
    ...
    private static void DiagnosticQueue()
    {
        ...
        Check(Enum.GetValues<GenericEventDiagnosticCode>().Length==115);
        Check((int)GenericEventDiagnosticCode.DiagnosticUnavailable==36);
        Check(GenericEventDiagnosticCodec.Normalize((GenericEventDiagnosticCode)115)==GenericEventDiagnosticCode.DiagnosticUnavailable);
        Check(GenericEventDiagnosticCodec.Encode((GenericEventDiagnosticCode)115)=="diagnostic_unavailable");
