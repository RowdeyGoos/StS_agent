...
ENABLED = b'{"schema_version":"item_probe_v1_transport_config_v1","enabled":true,"bind_address":"127.0.0.1","port":43117,"token_file":"credential.hex"}'
...
def read_credential(home: Path, uid: int, state: Any,
    ...
    try:
        ...
        item = open_entry('item_v1', private=True, owned=True)
