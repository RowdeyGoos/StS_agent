...
internal static class Program
{
    ...
    private static readonly string[] ProductionSources = {
        "bridge/Sts2AgentBridge/components/cards/core/CardSelectionV1Contracts.cs",
        "bridge/Sts2AgentBridge/components/cards/core/CardSelectionV1Session.cs",
        "bridge/Sts2AgentBridge/components/cards/native/CardSelectionV1NativeRules.cs",
        "bridge/Sts2AgentBridge/components/cards/parents/CardSelectionParentV1Contracts.cs",
        "bridge/Sts2AgentBridge/components/cards/wire/CardSelectionV1WireCodec.cs",
        "bridge/Sts2AgentBridge/components/cards/wire/CardSelectionV1WireProtocol.cs",
        "bridge/Sts2AgentBridge/apps/events/gameplay/GenericEventV7TransformAdapter.cs",
        "bridge/Sts2AgentBridge/apps/events/lifecycle/GenericEventBootstrapLifecycle.cs",
        "bridge/Sts2AgentBridge/apps/events/native/GenericEventBootstrapHost.cs",
        "bridge/Sts2AgentBridge/apps/events/native/GenericEventBootstrapSupport.cs",
        "bridge/Sts2AgentBridge/apps/events/native/GenericEventGodotFrameConnector.cs",
        "bridge/Sts2AgentBridge/apps/events/native/GenericEventModEntry.cs",
        "bridge/Sts2AgentBridge/apps/events/native/PinnedGenericEventHarmonyGuard.cs",
        "bridge/Sts2AgentBridge/apps/events/native/ProductionGenericEventRuntimeFactory.cs",
        "bridge/Sts2AgentBridge/apps/events/operator/GenericEventOperatorFiles.cs",
        "bridge/Sts2AgentBridge/apps/events/runtime/GenericEventDiagnosticCode.cs",
        "bridge/Sts2AgentBridge/apps/events/runtime/GenericEventDiagnosticCodec.cs",
        "bridge/Sts2AgentBridge/apps/events/runtime/GenericEventTransportConfiguration.cs",
        "bridge/Sts2AgentBridge/apps/events/runtime/GenericEventTransportContracts.cs",
        "bridge/Sts2AgentBridge/apps/events/runtime/GenericEventTransportProtocol.cs",
        "bridge/Sts2AgentBridge/apps/events/runtime/GenericEventTransportRuntime.cs",
        "bridge/Sts2AgentBridge/apps/events/runtime/OwnedByteFrameQueue.cs",
        "bridge/Sts2AgentBridge/components/events/core/GenericEventV5ChildSession.cs",
        "bridge/Sts2AgentBridge/components/events/core/GenericEventV7ChildSession.cs",
        "bridge/Sts2AgentBridge/components/events/core/GenericEventV7Contracts.cs",
        "bridge/Sts2AgentBridge/components/events/core/GenericEventV7ItemChildSession.cs",
        "bridge/Sts2AgentBridge/components/events/core/GenericEventV7NativeContracts.cs",
        "bridge/Sts2AgentBridge/components/events/core/GenericEventV7Session.cs",
        "bridge/Sts2AgentBridge/components/events/native/GenericEventV7Binding.cs",
        "bridge/Sts2AgentBridge/components/events/native/GenericEventV7CardAdapter.cs",
        "bridge/Sts2AgentBridge/components/events/native/GenericEventV7Hooks.cs",
        "bridge/Sts2AgentBridge/components/events/native/GenericEventV7ItemAdapter.cs",
        "bridge/Sts2AgentBridge/components/events/native/GenericEventV7ItemState.cs",
        "bridge/Sts2AgentBridge/components/events/native/GenericEventV7MultiUpgradeAdapter.cs",
        "bridge/Sts2AgentBridge/components/events/native/GenericEventV7MultiUpgradeState.cs",
        "bridge/Sts2AgentBridge/components/events/native/GenericEventV7RemovalAdapter.cs",
        "bridge/Sts2AgentBridge/components/events/native/GenericEventV7RewardAdapter.cs",
        "bridge/Sts2AgentBridge/components/events/native/GenericEventV7TransformState.cs",
        "bridge/Sts2AgentBridge/components/events/native/PinnedGenericEventV7NativeAdapter.cs",
        "bridge/Sts2AgentBridge/components/events/transform_core/CardTransformV2Journal.cs",
        "bridge/Sts2AgentBridge/components/events/transform_core/CardTransformV2NativeContracts.cs",
        "bridge/Sts2AgentBridge/components/events/transform_core/CardTransformV2Session.cs",
        "bridge/Sts2AgentBridge/components/events/wire/CardTransformV2WireCodec.cs",
        "bridge/Sts2AgentBridge/components/events/wire/GenericEventV7WireCodec.cs",
        "bridge/Sts2AgentBridge/components/events/wire/GenericEventV7WireService.cs",
        "bridge/Sts2AgentBridge/components/item_bootstrap/native/PinnedItemBuildGuard.cs",
        "bridge/Sts2AgentBridge/components/item_bootstrap/operator/DarwinReadOnly.cs",
        "bridge/Sts2AgentBridge/components/item_bootstrap/operator/ItemOperatorConfiguration.cs",
        "bridge/Sts2AgentBridge/components/item_bootstrap/operator/ItemPinnedFileIdentity.cs",
        "bridge/Sts2AgentBridge/components/item_transport/runtime/kernel/FixedTimeAuthenticator.cs",
        "bridge/Sts2AgentBridge/components/item_transport/runtime/kernel/MonotonicTokenBucket.cs",
        "bridge/Sts2AgentBridge/components/items/core/ItemV1CanonicalEncoder.cs",
        "bridge/Sts2AgentBridge/components/items/core/ItemV1Contracts.cs",
        "bridge/Sts2AgentBridge/components/items/core/ItemV1Session.cs",
        "bridge/Sts2AgentBridge/components/item_wire/producer/ItemWireV1Codec.cs",
        "bridge/Sts2AgentBridge/components/item_wire/producer/ItemWireV1Protocol.cs",
    };
    private const string ExpectedSourceProjectionSha256 = "3055edf7fc7b8a1002ec8c0f675c2c6ee24c059b826e3e87a6b3c56ef5f0614a";
    ...
    public static int Main(string[] args)
    {
        try
        {
            ...
            Console.WriteLine(JsonSerializer.Serialize(new SortedDictionary<string, object>(StringComparer.Ordinal)
            {
                ...
                ["schema_version"] = 1,
                ["status"] = "passed",
                ["suite"] = "generic_event_v10_release_verifier",
            }));
            return 0;
        }
        catch
        {
            Console.WriteLine("{\"schema_version\":1,\"status\":\"failed\",\"suite\":\"generic_event_v10_release_verifier\"}");
            return 1;
        }
    }
    ...
    private static void Run(string candidatePath, string sourceRoot, string policyPath)
    {
        ...
        Check(!projection.Inventory.Any(row => row.StartsWith("offscreen_api|", StringComparison.Ordinal)));
        foreach (string target in GenericEventOffscreenSurface.GeometryApis)
        {
            const string probe = "Sts2AgentBridge.Successors.GenericEventV7.Native.GenericEventV7TransformAdapter+ProbeGeometry";
            string owner = probe + ".TryBind(Grid,Candidate[],ProbeGeometry&)";
            Check(GenericEventReleaseProjectionBuilder.IsForbiddenRuntimeReference(owner, target));
            Check(GenericEventReleaseProjectionBuilder.IsForbiddenRuntimeReference(probe + "+NodeGeometry.TryBind(Node,Rid,NodeGeometry&)", target));
            Check(GenericEventReleaseProjectionBuilder.IsForbiddenRuntimeReference("Other.TryBind()", target));
            Reject(() => GenericEventOffscreenSurface.AddCall(owner, target, 0, 0x006f, new List<string>()), "offscreen_surface_forbidden");
            string[] changed = projection.Inventory.Append("offscreen_api|" + owner + "|0|111|" + target).ToArray();
            Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(projection with { Inventory = changed }), "offscreen_surface_forbidden");
        }

        foreach (string prefix in new[] { "hitbox_helper|", "hitbox_call|", "hitbox_call|Sts2AgentBridge.Successors.GenericEventV7.Native.GenericEventV7RewardAdapter.TryCaptureBindings(" })
        {
        ...
        Check(GenericEventReleaseProjectionBuilder.MetadataCell("<Item>g__Shape|2_0") == "<Item>g__Shape%7C2_0");
        Check(GenericEventReleaseProjectionBuilder.MetadataCell("x%7Cy|z\r\n") == "x%257Cy%7Cz%0D%0A");
        Check(GenericEventReleaseProjectionBuilder.MetadataCell("|") != GenericEventReleaseProjectionBuilder.MetadataCell("%7C"));
        foreach (string malformedCell in new[] { "|", "%7c", "%" })
        {
            string[] changed = projection.Inventory.ToArray();
            int index = Array.FindIndex(changed, row => row.StartsWith("method_def|", StringComparison.Ordinal) && row.Contains("%7C", StringComparison.Ordinal));
            if (index < 0) throw new InvalidOperationException("local-function metadata missing");
            changed[index] = changed[index].Replace("%7C", malformedCell, StringComparison.Ordinal);
            Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(projection with { Inventory = changed }), "metadata_token_linkage");
        }
        const string hookOwner = "Sts2AgentBridge.Successors.GenericEventV7.Native.GenericEventV7Hooks.Hook(System.String)";
        const string guardOwner = "Sts2AgentBridge.Successors.GenericEventReleaseV10.PinnedGenericEventHarmonyGuard.Verify()";
        ...
        Check(GenericEventReleaseProjectionBuilder.IsForbiddenRuntimeReference(hookOwner.Replace("GenericEventV7Hooks.", "GenericEventV7HooksExtra.", StringComparison.Ordinal), getMethod));
        const string boundHookOwner = "Sts2AgentBridge.Successors.GenericEventV7.Native.GenericEventV7Hooks..ctor(System.Action<System.Int32>,System.Action)";
        const string boundGetMethod = "member:System.Type.GetMethod(System.String,System.Reflection.BindingFlags,System.Reflection.Binder,System.Type[],System.Reflection.ParameterModifier[])";
        foreach (string metadataRead in new[] { boundGetMethod,
            "member:System.Reflection.MethodBase.get_IsPublic()", "member:System.Reflection.MethodBase.get_IsPrivate()",
            "member:System.Reflection.MethodBase.get_IsStatic()", "member:System.Reflection.MethodBase.get_IsGenericMethod()",
            "member:System.Reflection.MethodInfo.get_ReturnType()" })
        {
            Check(!GenericEventReleaseProjectionBuilder.IsForbiddenRuntimeReference(boundHookOwner, metadataRead));
            Check(GenericEventReleaseProjectionBuilder.IsForbiddenRuntimeReference(hookOwner, metadataRead));
            Check(GenericEventReleaseProjectionBuilder.IsForbiddenRuntimeReference(boundHookOwner + "Extra", metadataRead));
        }
        foreach (string diagnosticType in new[] { "GenericEventDiagnosticCode", "GenericEventDiagnosticCodec" })
        {
            string prefix = "type_def|Sts2AgentBridge.Successors.GenericEventReleaseV5." + diagnosticType + "|";
            string[] changed = projection.Inventory.ToArray();
            int index = Array.FindIndex(changed, row => row.StartsWith(prefix, StringComparison.Ordinal));
            if (index < 0) throw new InvalidOperationException("retained diagnostic type missing");
            string replacement = changed[index].Replace("GenericEventReleaseV5.", "GenericEventReleaseV10.", StringComparison.Ordinal);
            ...
            {
                Inventory = projection.Inventory.Append(replacement).ToArray(),
            }), "diagnostic_surface_forbidden");
        }
        ...
        // Each appended diagnostic is independently bound in metadata and literal IL.
        // Mutations operate on bytes or projections; the production assembly is never loaded.
        foreach (var (name, word, value) in new[]
        {
            ("GeometryCandidateCount","geometry_candidate_count",78),
            ("GeometryScrollMissing","geometry_scroll_missing",79),
            ("GeometryScrollInvalid","geometry_scroll_invalid",80),
            ("GeometryScrollInvisible","geometry_scroll_invisible",81),
            ("GeometryScrollSize","geometry_scroll_size",82),
            ("GeometryScrollPosition","geometry_scroll_position",83),
            ("GeometryGridSize","geometry_grid_size",84),
            ("GeometryCardSize","geometry_card_size",85),
            ("GeometryYOffset","geometry_y_offset",86),
            ("GeometryColumns","geometry_columns",87),
            ("GeometryScrollHeightMismatch","geometry_scroll_height_mismatch",88),
            ("GeometryScrollPositionMismatch","geometry_scroll_position_mismatch",89),
            ("GeometryClipSearchInvalid","geometry_clip_search_invalid",90),
            ("GeometryClipSearchCycle","geometry_clip_search_cycle",91),
            ("GeometryClipSearchDepth","geometry_clip_search_depth",92),
            ("GeometryClipMissing","geometry_clip_missing",93),
            ("GeometryClipRect","geometry_clip_rect",94),
            ("GeometryCanvasInvalid","geometry_canvas_invalid",95),
            ("GeometryChainInvalid","geometry_chain_invalid",96),
            ("GeometryChainNonCanvas","geometry_chain_non_canvas",97),
            ("GeometryChainCycle","geometry_chain_cycle",98),
            ("GeometryChainDepth","geometry_chain_depth",99),
            ("GeometryChainUnreached","geometry_chain_unreached",100),
            ("GeometryTopLevel","geometry_top_level",101),
            ("GeometryCanvasMismatch","geometry_canvas_mismatch",102),
            ("GeometryTransform","geometry_transform",103),
            ("GeometryNodeRect","geometry_node_rect",104),
            ("GeometryControlRect","geometry_control_rect",105),
            ("GeometryClipChanged","geometry_clip_changed",106),
            ("GeometryParentChanged","geometry_parent_changed",107),
            ("GeometryTransformChanged","geometry_transform_changed",108),
            ("GeometryNodeClipChanged","geometry_node_clip_changed",109),
            ("GeometryRectChanged","geometry_rect_changed",110),
            ("GeometryMaskCount","geometry_mask_count",111),
            ("GeometryInitiallySelected","geometry_initially_selected",112),
            ("GeometryCandidateInvisible","geometry_candidate_invisible",113),
            ("GeometryNoneEligible","geometry_none_eligible",114)
        })
        {
            foreach (string prefix in new[] { "diagnostic_enum|" + name + "|", "diagnostic_mapping|" + value + "|" })
            {
                string[] changed = projection.Inventory.ToArray();
                int index = Array.FindIndex(changed, row => row.StartsWith(prefix, StringComparison.Ordinal));
                if (index < 0) throw new InvalidOperationException("geometry diagnostic inventory missing");
                changed[index] += "_altered";
                Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(projection with { Inventory = changed }), "diagnostic_surface_forbidden");
            }
            foreach (byte[] changed in new[]
            {
                PeMutations.ChangeDiagnosticEnumValue(candidate, name, value == 114 ? 115 : value + 1),
                PeMutations.ChangeDiagnosticMappingString(candidate, word),
            })
            {
                Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(GenericEventReleaseProjectionBuilder.Build(changed)), "diagnostic_surface_forbidden");
                ProductionReject(changed, sourceRoot, policyPath, "diagnostic_surface_forbidden");
        ...
        Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(projection with
        {
            ...
            {
                "method_def|06ffffff|Sts2AgentBridge.Successors.GenericEventReleaseV10.GenericEventModEntry.Initialize(System.String)|System.Void|0|1|0|150|0",
            }).OrderBy(value => value, StringComparer.Ordinal).ToArray(),
        }), "initializer_or_friend_surface");
        ...
        {
            ("GET /probe/generic-event-v7/public/decision HTTP/1.1", "GET /probe/generic-event-v7/public/decisio0 HTTP/1.1"),
            ("POST /probe/generic-event-v7/public/action HTTP/1.1", "POST /probe/generic-event-v7/public/actio0 HTTP/1.1"),
        })
        {
        ...
        byte[] wrapperBypass = PeMutations.ChangeCriticalTypeName(
            candidate, "PinnedGenericEventV7NativeAdapter");
        Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(
        ...
        byte[] frameBypass = PeMutations.ChangeCriticalTypeName(
            candidate, "GenericEventV7WireService");
        Reject(() => GenericEventReleaseVerifier.VerifySemanticRules(
    ...
    private static (int Exit, string Output) InvokeProduction(string candidate, string sourceRoot, string policy)
    {
        ...
        try
        {
            ...
            int exit = Sts2AgentBridge.Successors.GenericEventReleaseV10.Program.Main(new[]
            {
