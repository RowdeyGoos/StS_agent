...
_MANIFEST_SHA256 = "306a2737ce330a409847b30b62bf20c4162a2bd6e08b5f657539607f593817a3"
...
class _Fixture:
    ...
    def install_overlay(self, manifest: bytes | None = None) -> None:
        ...
        (directory / "Sts2AgentBridgeGenericEventV10.dll").write_bytes(self.dll)
        (directory / "Sts2AgentBridgeGenericEventV10.json").write_bytes(
...
def operation() -> dict[str, object]:
    ...
    with tempfile.TemporaryDirectory(
        ...
        mutated[mutated.index(b"Generic Event V10")] ^= 1
