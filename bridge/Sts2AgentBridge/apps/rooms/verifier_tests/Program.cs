...
internal static class Program
{
    ...
    private static readonly string[] ProductionSources =
    {
        ...
        "bridge/Sts2AgentBridge/components/item_wire/producer/ItemWireV1Service.cs",
        "bridge/Sts2AgentBridge/components/rooms/broker/FrozenEventItemChildBroker.cs",
        "bridge/Sts2AgentBridge/components/rooms/common/EventItemChildContracts.cs",
        "bridge/Sts2AgentBridge/components/rooms/common/RoomFlowContracts.cs",
        "bridge/Sts2AgentBridge/components/rooms/event/core/EventV1CanonicalEncoder.cs",
        "bridge/Sts2AgentBridge/components/rooms/event/core/EventV1Contracts.cs",
        "bridge/Sts2AgentBridge/components/rooms/event/core/EventV1Session.cs",
        "bridge/Sts2AgentBridge/components/rooms/event/native/PinnedEventV1NativeAdapter.cs",
        "bridge/Sts2AgentBridge/components/rooms/shop/core/ShopV1CanonicalEncoder.cs",
        "bridge/Sts2AgentBridge/components/rooms/shop/core/ShopV1Contracts.cs",
        "bridge/Sts2AgentBridge/components/rooms/shop/native/PinnedShopV1NativeAdapter.cs",
        "bridge/Sts2AgentBridge/components/rooms/wire/RoomFlowWireCodec.cs",
        "bridge/Sts2AgentBridge/components/rooms/wire/RoomFlowWireService.cs",
        "bridge/Sts2AgentBridge/apps/rooms/lifecycle/RoomFlowBootstrapLifecycle.cs",
        "bridge/Sts2AgentBridge/apps/rooms/native/ProductionRoomFlowRuntimeFactory.cs",
        "bridge/Sts2AgentBridge/apps/rooms/native/RoomFlowBootstrapHost.cs",
        "bridge/Sts2AgentBridge/apps/rooms/native/RoomFlowBootstrapSupport.cs",
        "bridge/Sts2AgentBridge/apps/rooms/native/RoomFlowGodotFrameConnector.cs",
        "bridge/Sts2AgentBridge/apps/rooms/native/RoomFlowModEntry.cs",
        "bridge/Sts2AgentBridge/apps/rooms/operator/RoomFlowOperatorFiles.cs",
        "bridge/Sts2AgentBridge/apps/rooms/runtime/OwnedByteFrameQueue.cs",
        "bridge/Sts2AgentBridge/apps/rooms/runtime/RoomFlowTransportConfiguration.cs",
        "bridge/Sts2AgentBridge/apps/rooms/runtime/RoomFlowTransportContracts.cs",
        "bridge/Sts2AgentBridge/apps/rooms/runtime/RoomFlowTransportProtocol.cs",
        "bridge/Sts2AgentBridge/apps/rooms/runtime/RoomFlowTransportRuntime.cs",
        "bridge/Sts2AgentBridge/components/rooms/shop/core/ShopV1Session.cs",
    };
