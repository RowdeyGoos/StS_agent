...
internal sealed class RoomFlowGodotFrameConnector : IRoomFlowBootstrapFrameConnector
{
    public IRoomFlowBootstrapFrameAttachment? Attach(Action onFrame)
    {
    ...
    private sealed class Attachment : IRoomFlowBootstrapFrameAttachment
    {
