"""Descriptor-bound read lease for the one fixed unified bridge operator tree."""
...
CONFIGURATIONS = {"unified": b'{"schema_version":"bridge_transport_config_v1","enabled":true,"bind_address":"127.0.0.1","port":43117,"token_file":"credential.hex"}'}
...
def read_credential(home: Path, uid: int, state: Any,
    ...
    try:
        ...
        item = open_entry('unified', private=True, owned=True)
