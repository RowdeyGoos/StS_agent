...
internal sealed class BridgeGodotFrameConnector : IBridgeBootstrapFrameConnector
{
    public IBridgeBootstrapFrameAttachment? Attach(Action onFrame)
    {
    ...
    private sealed class Attachment : IBridgeBootstrapFrameAttachment
    {
